...
class SaleSubscription(models.Model):
    ...
    def partial_invoice_line(self, sale_order, option_line, refund=False, date_from=False):
        ...
        values = {
            ...
            'name': order_line_obj.get_sale_order_line_multiline_description_sale(
    ...
    def _recurring_create_invoice(self, automatic=False, batch_size=20):
        ...
        if automatic:
            ...
            if automatic and auto_commit:
                cr.commit()
            domain_search = self._get_subscription_domain_for_invoicing(current_date, subscription_payment_exception_tag | batch_tag)
